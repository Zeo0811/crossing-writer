...
export const TRANSITIONS: Record<ProjectStatus, ProjectStatus[]> = {
  ...
  awaiting_mission_pick: ["mission_approved_preview", "round1_running"],
  mission_approved_preview: ["mission_refining", "mission_approved"],
  mission_refining: ["mission_review", "mission_approved_preview"],
  mission_review: ["mission_refining", "mission_approved"],
